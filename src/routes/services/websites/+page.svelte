...
<div class="content-grid pt-[10vh] md:pt-[20vh]" bind:this={spacer}>
    ...
    <section class="text-center h-[50vh] grid place-content-center justify-items-center">
        <h1 class="title-2">Websites that keep clients engaged</h1>
    </section>
        ...
        <div class="grid gap-y-16 sm:grid-cols-5 lg:grid-cols-6">
            <div class="sm:col-span-2 fade-in-up">
                <div class="flex gap-x-3">
                    ...
                    <div class="font-medium grid content-center">
                        <h3 class="text-[1.1rem]">Byereta Bruce</h3>
            ...
            <div class="sm:col-span-3 lg:col-span-4">
                <p class="text-2xl lg:text-4xl font-medium fade-in-up">
                    <span class="opacity-0">Businesses</span>A professional website builds credibility and trust. Reach more customers with a responsive and mobile-friendly site. Optimized for speed, SEO, and security to drive growth.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-32">
        ...
        <div class="grid gap-y-3 lg:grid-cols-5">
        ...
        <div class="grid gap-y-16 gap-x-8 sm:grid-cols-5 lg:grid-cols-6">
            <div class="sm:col-span-2 fade-in-top">
                <div class="p-6 rounded-2xl rounded-tr-[0] outline outline-lead grid gap-y-10">
                    ...
                    <a href="#" class="grid">
                        <button class="px-6 py-3 text-lg font-medium text-white bg-blue rounded-lg [text-decoration:none]">
                            Connect on LinkedIn
                        </button>
                    </a>
                </div>
    ...
    <div class="py-32">
        ...
        <div class="gap-3 flex flex-wrap justify-center md:gap-6 lg:gap-12">
            ...
            <div class="rounded-full border border-lead h-40 w-40 md:h-48 md:w-48 grid place-content-center fade-in-up">
    ...
    <!-- CTA Section -->
    <section class="py-32">
        <div class="bg-gradient-to-tr from-15% from-[#FF4B56] to-red to-75% p-32 rounded-4xl grid place-content-center">
            <div class="bg-white text-dark text-center p-16 rounded-2xl w-fit max-w-[500px] grid gap-y-6">
                ...
                <a href="/contact">
                    <button class="px-6 py-3 text-lg font-medium text-white bg-red rounded-lg [text-decoration:none]">
                        Lets Get Started
                    </button>
                </a>
            </div>
