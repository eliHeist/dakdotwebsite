...
<div class="hero full-width sticky top-0 h-screen grid place-content-center -z-10">
    <img src="/svgs/yellow-half-tone.svg" alt="" class="object-cover h-full w-full lg:opacity-90 absolute -z-10">
    <h1 class="title-3 [backdrop-filter:shadow(0_4px_4px_rgba(255,0,0,0.75)]">Turn Stills <br /> into Stories <br> with Motion</h1>
</div>
			...
			<div class="scroller__inner gap-x-3">
				{#each data.products as word}
					<div class="px-3 flex gap-x-2 items-center w-max">
						<Star class="fill-yellow stroke-yellow h-4" />
						<span>{word}</span>
					</div>
				{/each}
			</div>
		...
		<div class="grid gap-y-16 sm:grid-cols-5 lg:grid-cols-6">
			<div class="sm:col-span-2 fade-in-up">
				<div class="flex gap-x-3">
					...
					<div class="font-medium grid content-center">
						<h3 class="text-[1.1rem]">Bruce Byereta</h3>
						<p class="text-lead/80">Creative Lead, DakDot</p>
					</div>
				</div>
			</div>
			<div class="sm:col-span-3 lg:col-span-4">
				<div class="text-2xl lg:text-4xl font-medium fade-in-up">
                    <WelcomeText>
                        <span class="opacity-0">Businesses</span>In today’s digital world, visual storytelling is key to engaging audiences. Our motion and video production services bring your brand’s vision to life through high-quality animations, motion graphics, VFX, and expert post-production. Whether you need captivating explainer videos, dynamic advertisements, or seamless video editing, we ensure that your content leaves a lasting impact.
                    </WelcomeText>
				</div>
			</div>
		</div>
			...
			<div class="sm:col-span-2 fade-in-top">
				<div class="p-6 rounded-2xl rounded-tr-[0] outline outline-lead grid gap-y-10">
					<div class="flex gap-x-3">
						...
						<div class="font-medium grid content-center">
							<h3 class="">Oscar Kayima</h3>
							<p class="text-lead/80 text-sm">Animation Lead, DakDot</p>
						</div>
					</div>
					<p>
