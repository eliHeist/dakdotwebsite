        ...
        <div class="grid gap-y-16 sm:grid-cols-5 lg:grid-cols-6">
            ...
            <div class="sm:col-span-3 lg:col-span-4">
                <p class="text-2xl lg:text-4xl font-medium fade-in-up">
                    <span class="opacity-0">Businesses</span>In today’s digital world, businesses need more than just a website—they need powerful, interactive web applications that automate operations, store information and define operations systems.</p>
            </div>
        </div>
    </section>
