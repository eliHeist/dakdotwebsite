			...
			<div class="">
				...
				<div class="grid gap-y-3 text-lg mt-4 sm:mt-10">
					...
					<div class="flex gap-x-4">
						<a href="https://x.com/dakdotagency" class="slide-in-left">
						...
						<a href="https://www.instagram.com/dakdotagency/" class="slide-in-left">
						...
						<a href="https://www.linkedin.com/company/106117703/admin/dashboard/" class="slide-in-left">
							<svg class="h-6 hover:fill-red" viewBox="0 0 448 512"
								><path
